        ...
        for ($bars = 0; $bars <= 10; $bars++) {
            ...
            <div class=\"progress\">
                <div class=\"progress-bar progress-bar-striped active\" role=\"progressbar\"
                     aria-valuenow=\"40\" aria-valuemin=\"0\" aria-valuemax=\"100\" style=\"counter-reset: ;lor:black;background-color: #5bc0de; margin-bottom:0px;width:{$result[$count][1]}%;\">{$result[$count][1]} </div>
            </div>";
                    break;
                case 2:
